...
if RANK == 0 ##### MANAGER #####
    ...
    function main1(task)
        ...
        try
            if cut == :all
                EE_z, EE_y, EE_xz, TMI_z, TMI_y, TMI_xz = simulate(L, p;cut = cut, iterations=iterations, thermalization_steps=thermalization)
                ...
                return (p, EE_z, EE_y, EE_xz, TMI_z, TMI_y, TMI_xz)
            else
