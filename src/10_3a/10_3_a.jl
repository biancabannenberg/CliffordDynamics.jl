### this will later all be just in the main File
...
abstract type Hyperoctagon <: Lattice end

####### nearest neighbors ######
#the (10,3)a lattice has a basis of 4 sites
local L_unitcell = 4

struct HyperoctagonLattice <: Hyperoctagon
    L::Int
    N::Int
    L_unit::Int
    params::Vector{Any}
...
function Hyperoctaconlattice(L)
    N = L^3 * L_unitcell
    return HyperoctagonLattice(L, N, L_unitcell, [], 0, 0, 0)
end
