...
if RANK == 0 ##### MANAGER #####
    ...
    function main1(task)
        ...
        #do stuff
        try
            Sx, Sy, Tx, Ty, r = main([p,1-p,0], L; initialize = method, iterations = iterations, thermalization = thermalization, between_measurements = between_measurements, newstarts = newstarts, prep_cat = prep_cat)  
